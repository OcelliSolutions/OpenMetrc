...
public partial class MetrcService : IHarvestClient
{
    ...
    Task IHarvestClient.
        PostHarvestCreatePackagesAsync(string licenseNumber, IEnumerable<PostHarvestCreatePackagesRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : HarvestClient.PostHarvestCreatePackagesAsync(licenseNumber, body);
    ...
    Task IHarvestClient.PostHarvestCreatePackageTestingAsync(string licenseNumber,
        ...
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : HarvestClient.PostHarvestCreatePackageTestingAsync(licenseNumber, body);
    ...
    Task IHarvestClient.PutHarvestMoveAsync(string licenseNumber, IEnumerable<PutHarvestMoveRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : HarvestClient.PutHarvestMoveAsync(licenseNumber, body);
    ...
    Task IHarvestClient.PostHarvestRemoveWasteAsync(string licenseNumber, IEnumerable<PostHarvestRemoveWasteRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : HarvestClient.PostHarvestRemoveWasteAsync(licenseNumber, body);
    ...
    Task IHarvestClient.PostHarvestFinishAsync(string licenseNumber, IEnumerable<PostHarvestFinishRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : HarvestClient.PostHarvestFinishAsync(licenseNumber, body);
    ...
    Task IHarvestClient.PostHarvestUnfinishAsync(string licenseNumber, IEnumerable<PostHarvestUnfinishRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : HarvestClient.PostHarvestUnfinishAsync(licenseNumber, body);
