...
public partial class MetrcService : IItemClient
{
    ...
    Task<ICollection<Item>?> IItemClient.GetItemActiveAsync(string licenseNumber) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.FromResult<ICollection<Item>?>(new List<Item>())
            : ItemClient.GetItemActiveAsync(licenseNumber);
    ...
    Task<ICollection<Item>?> IItemClient.GetItemInactiveAsync(string licenseNumber) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.FromResult<ICollection<Item>?>(new List<Item>())
            : ItemClient.GetItemInactiveAsync(licenseNumber);
    ...
    Task IItemClient.PostItemCreateAsync(string licenseNumber, IEnumerable<PostItemCreateRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : ItemClient.PostItemCreateAsync(licenseNumber, body);
    ...
    Task IItemClient.PostItemUpdateAsync(string licenseNumber, IEnumerable<PostItemUpdateRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : ItemClient.PostItemUpdateAsync(licenseNumber, body);
