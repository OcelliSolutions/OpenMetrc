...
public partial class MetrcService : IHarvestClient
{
    ...
    Task<HarvestWasteMetrcWrapper> IHarvestClient.GetHarvestWasteAsync(string licenseNumber, long harvestId, int? pageNumber, int? pageSize) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.FromResult(new HarvestWasteMetrcWrapper())
            : HarvestClient.GetHarvestWasteAsync(licenseNumber, harvestId, pageNumber, pageSize);
    ...
    Task<HarvestWasteTypeMetrcWrapper> IHarvestClient.GetHarvestWasteTypesAsync(int? pageNumber, int? pageSize) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.FromResult(new HarvestWasteTypeMetrcWrapper())
            : HarvestClient.GetHarvestWasteTypesAsync(pageNumber, pageSize);
    ...
    Task IHarvestClient.
        PostHarvestPackagesAsync(string licenseNumber, IEnumerable<PostHarvestPackagesRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : HarvestClient.PostHarvestPackagesAsync(licenseNumber, body);
    ...
    Task IHarvestClient.PostHarvestPackageTestingAsync(string licenseNumber,
        ...
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : HarvestClient.PostHarvestPackageTestingAsync(licenseNumber, body);
    ...
    Task IHarvestClient.PutHarvestLocationAsync(string licenseNumber, IEnumerable<PutHarvestLocationRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : HarvestClient.PutHarvestLocationAsync(licenseNumber, body);
    ...
    Task IHarvestClient.PostHarvestWasteAsync(string licenseNumber, IEnumerable<PostHarvestWasteRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : HarvestClient.PostHarvestWasteAsync(licenseNumber, body);
    ...
    Task IHarvestClient.PutHarvestRenameAsync(string licenseNumber, IEnumerable<PutHarvestRenameRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : HarvestClient.PutHarvestRenameAsync(licenseNumber, body);
    ...
    Task IHarvestClient.PutHarvestFinishAsync(string licenseNumber, IEnumerable<PutHarvestFinishRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : HarvestClient.PutHarvestFinishAsync(licenseNumber, body);
    ...
    Task IHarvestClient.PutHarvestUnfinishAsync(string licenseNumber, IEnumerable<PutHarvestUnfinishRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : HarvestClient.PutHarvestUnfinishAsync(licenseNumber, body);
    ...
    Task IHarvestClient.PutHarvestRestoreHarvestedPlantsAsync(string licenseNumber, IEnumerable<PutHarvestRestoreHarvestedPlantsRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : HarvestClient.PutHarvestRestoreHarvestedPlantsAsync(licenseNumber, body);
    ...
    Task IHarvestClient.DeleteHarvestWasteByIdAsync(long id, string licenseNumber) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : HarvestClient.DeleteHarvestWasteByIdAsync(id, licenseNumber);
