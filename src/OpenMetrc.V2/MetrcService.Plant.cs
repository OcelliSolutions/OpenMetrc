...
public partial class MetrcService : IPlantClient
{
    ...
    Task IPlantClient.PostPlantAdditivesAsync(string licenseNumber, IEnumerable<PostPlantAdditivesRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : PlantClient.PostPlantAdditivesAsync(licenseNumber, body);
    ...
    Task IPlantClient.PutPlantTagAsync(string licenseNumber, IEnumerable<PutPlantTagRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : PlantClient.PutPlantTagAsync(licenseNumber, body);
    ...
    Task IPlantClient.PutPlantStrainAsync(string licenseNumber, IEnumerable<PutPlantStrainRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : PlantClient.PutPlantStrainAsync(licenseNumber, body);
    ...
    Task<StringMetrcWrapper> IPlantClient.GetPlantAdditiveTypesAsync() =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.FromResult(new StringMetrcWrapper())
            : PlantClient.GetPlantAdditiveTypesAsync();
    ...
    Task<PlantWasteMethodMetrcWrapper> IPlantClient.GetPlantWasteMethodAllAsync(int? pageNumber, int? pageSize) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.FromResult(new PlantWasteMethodMetrcWrapper())
            : PlantClient.GetPlantWasteMethodAllAsync(pageNumber, pageSize);
    ...
    Task IPlantClient.PutPlantSplitAsync(string licenseNumber, IEnumerable<PutPlantSplitRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : PlantClient.PutPlantSplitAsync(licenseNumber, body);
    ...
    Task<PlantWasteReasonMetrcWrapper> IPlantClient.GetPlantWasteReasonsAsync(string licenseNumber,
        ...
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ...
            : PlantClient.GetPlantWasteReasonsAsync(licenseNumber, pageNumber, pageSize);
    ...
    Task IPlantClient.PutPlantLocationAsync(string licenseNumber, IEnumerable<PutPlantLocationRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : PlantClient.PutPlantLocationAsync(licenseNumber, body);
    ...
    Task IPlantClient.PutPlantGrowthPhaseAsync(string licenseNumber,
        ...
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : PlantClient.PutPlantGrowthPhaseAsync(licenseNumber, body);
    ...
    Task IPlantClient.DeletePlantsAsync(string licenseNumber, IEnumerable<DeletePlantsRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : PlantClient.DeletePlantsAsync(licenseNumber, body);
    ...
    Task IPlantClient.PostPlantWasteAsync(string licenseNumber, IEnumerable<PostPlantWasteRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : PlantClient.PostPlantWasteAsync(licenseNumber, body);
    ...
    Task IPlantClient.PostPlantAdditiveByLocationAsync(string licenseNumber,
        IEnumerable<PostPlantAdditiveByLocationRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : PlantClient.PostPlantAdditiveByLocationAsync(licenseNumber, body);
    ...
    Task IPlantClient.PostPlantPlantingsAsync(string licenseNumber, IEnumerable<PostPlantPlantingsRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : PlantClient.PostPlantPlantingsAsync(licenseNumber, body);
    ...
    Task IPlantClient.PostPlantPlantBatchPackagesAsync(string licenseNumber,
        IEnumerable<PostPlantPlantBatchPackagesRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : PlantClient.PostPlantPlantBatchPackagesAsync(licenseNumber, body);
    ...
    Task IPlantClient.PutPlantHarvestAsync(string licenseNumber, IEnumerable<PutPlantHarvestRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : PlantClient.PutPlantHarvestAsync(licenseNumber, body);
    ...
    Task IPlantClient.PutPlantMergeAsync(string licenseNumber, IEnumerable<PutPlantMergeRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : PlantClient.PutPlantMergeAsync(licenseNumber, body);
    ...
    Task IPlantClient.PostPlantManicureAsync(string licenseNumber, IEnumerable<PostPlantManicureRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : PlantClient.PostPlantManicureAsync(licenseNumber, body);
