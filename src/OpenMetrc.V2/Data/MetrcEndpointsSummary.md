...
| **CaregiversStatus** | **AK** | **AL** | **CA** | **CO** | **DC** | **GU** | **KY** | **LA** | **MA** | **MD** | **ME** | **MI** | **MN** | **MO** | **MS** | **MT** | **NJ** | **NV** | **OH** | **OK** | **OR** | **RI** | **SD** | **WV** |
| --- |  --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| get_caregivers_v2_status_caregiverLicenseNumber |  |  |  |  |  | x |  |  |  |  |  |  | x |  | x |  | x |  |  |  |  | x | x |  |
| **Employees** | **AK** | **AL** | **CA** | **CO** | **DC** | **GU** | **KY** | **LA** | **MA** | **MD** | **ME** | **MI** | **MN** | **MO** | **MS** | **MT** | **NJ** | **NV** | **OH** | **OK** | **OR** | **RI** | **SD** | **WV** |
| get_employees_v2 |  |  | x | x | x | x |  | x | x | x | x | x |  | x | x | x | x | x | x | x | x | x | x | x |
| **Facilities** | **AK** | **AL** | **CA** | **CO** | **DC** | **GU** | **KY** | **LA** | **MA** | **MD** | **ME** | **MI** | **MN** | **MO** | **MS** | **MT** | **NJ** | **NV** | **OH** | **OK** | **OR** | **RI** | **SD** | **WV** |
| get_facilities_v2 |  |  | x | x | x | x |  | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x |
| **Harvests** | **AK** | **AL** | **CA** | **CO** | **DC** | **GU** | **KY** | **LA** | **MA** | **MD** | **ME** | **MI** | **MN** | **MO** | **MS** | **MT** | **NJ** | **NV** | **OH** | **OK** | **OR** | **RI** | **SD** | **WV** |
...
| **Items** | **AK** | **AL** | **CA** | **CO** | **DC** | **GU** | **KY** | **LA** | **MA** | **MD** | **ME** | **MI** | **MN** | **MO** | **MS** | **MT** | **NJ** | **NV** | **OH** | **OK** | **OR** | **RI** | **SD** | **WV** |
...
| **LabTests** | **AK** | **AL** | **CA** | **CO** | **DC** | **GU** | **KY** | **LA** | **MA** | **MD** | **ME** | **MI** | **MN** | **MO** | **MS** | **MT** | **NJ** | **NV** | **OH** | **OK** | **OR** | **RI** | **SD** | **WV** |
...
| delete_patients_v2_id |  |  |  | x |  | x |  | x | x |  |  |  |  | x | x | x | x | x |  | x |  | x | x | x |
| get_patients_v2_active |  |  |  | x |  | x |  | x | x |  |  |  |  | x | x | x | x | x |  | x |  | x | x | x |
| get_patients_v2_id |  |  |  | x |  | x |  | x | x |  |  |  |  | x | x | x | x | x |  | x |  | x | x | x |
| post_patients_v2 |  |  |  | x |  | x |  | x | x |  |  |  |  | x | x | x | x | x |  | x |  | x | x | x |
| put_patients_v2 |  |  |  | x |  | x |  | x | x |  |  |  |  | x | x | x | x | x |  | x |  | x | x | x |
...
| delete_processing_v2_id |  |  |  |  |  | x |  |  |  |  |  |  |  |  |  | x | x | x |  |  | x | x |  |  |
| delete_processing_v2_jobtypes_id |  |  |  |  |  | x |  |  |  |  |  |  |  |  |  | x | x | x |  |  | x | x |  |  |
| get_processing_v2_active |  |  |  |  |  | x |  |  |  |  |  |  |  |  |  | x | x | x |  |  | x | x |  |  |
| get_processing_v2_id |  |  |  |  |  | x |  |  |  |  |  |  |  |  |  | x | x | x |  |  | x | x |  |  |
| get_processing_v2_inactive |  |  |  |  |  | x |  |  |  |  |  |  |  |  |  | x | x | x |  |  | x | x |  |  |
| get_processing_v2_jobtypes_active |  |  |  |  |  | x |  |  |  |  |  |  |  |  |  | x | x | x |  |  | x | x |  |  |
| get_processing_v2_jobtypes_attributes |  |  |  |  |  | x |  |  |  |  |  |  |  |  |  | x | x | x |  |  | x | x |  |  |
| get_processing_v2_jobtypes_categories |  |  |  |  |  | x |  |  |  |  |  |  |  |  |  | x | x | x |  |  | x | x |  |  |
| get_processing_v2_jobtypes_inactive |  |  |  |  |  | x |  |  |  |  |  |  |  |  |  | x | x | x |  |  | x | x |  |  |
| post_processing_v2_adjust |  |  |  |  |  | x |  |  |  |  |  |  |  |  |  | x | x | x |  |  | x | x |  |  |
| post_processing_v2_createpackages |  |  |  |  |  | x |  |  |  |  |  |  |  |  |  | x | x | x |  |  | x | x |  |  |
| post_processing_v2_jobtypes |  |  |  |  |  | x |  |  |  |  |  |  |  |  |  | x | x | x |  |  | x | x |  |  |
| post_processing_v2_start |  |  |  |  |  | x |  |  |  |  |  |  |  |  |  | x | x | x |  |  | x | x |  |  |
| put_processing_v2_finish |  |  |  |  |  | x |  |  |  |  |  |  |  |  |  | x | x | x |  |  | x | x |  |  |
| put_processing_v2_jobtypes |  |  |  |  |  | x |  |  |  |  |  |  |  |  |  | x | x | x |  |  | x | x |  |  |
| put_processing_v2_unfinish |  |  |  |  |  | x |  |  |  |  |  |  |  |  |  | x | x | x |  |  | x | x |  |  |
...
| get_tags_v2_package_available |  | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x |
| get_tags_v2_plant_available |  | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x |
...
| delete_transporters_v2_drivers_id |  | x | x | x | x | x |  | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x |
| delete_transporters_v2_vehicles_id |  | x | x | x | x | x |  | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x |
| get_transporters_v2_drivers |  | x | x | x | x | x |  | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x |
| get_transporters_v2_drivers_id |  | x | x | x | x | x |  | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x |
| get_transporters_v2_vehicles |  | x | x | x | x | x |  | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x |
| get_transporters_v2_vehicles_id |  | x | x | x | x | x |  | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x |
| post_transporters_v2_drivers |  | x | x | x | x | x |  | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x |
| post_transporters_v2_vehicles |  | x | x | x | x | x |  | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x |
| put_transporters_v2_drivers |  | x | x | x | x | x |  | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x |
| put_transporters_v2_vehicles |  | x | x | x | x | x |  | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x |
| **UnitsOfMeasure** | **AK** | **AL** | **CA** | **CO** | **DC** | **GU** | **KY** | **LA** | **MA** | **MD** | **ME** | **MI** | **MN** | **MO** | **MS** | **MT** | **NJ** | **NV** | **OH** | **OK** | **OR** | **RI** | **SD** | **WV** |
| get_unitsofmeasure_v2_active |  | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x |
| get_unitsofmeasure_v2_inactive |  | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x |
