...
public partial class MetrcService : IPlantBatchClient
{
    ...
    Task<StringMetrcWrapper> IPlantBatchClient.GetPlantBatchTypesAsync(int? pageNumber, int? pageSize) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.FromResult(new StringMetrcWrapper())
            : PlantBatchClient.GetPlantBatchTypesAsync(pageNumber, pageSize);
    ...
    Task IPlantBatchClient.PostPlantBatchPlantingsAsync(string licenseNumber,
        IEnumerable<PostPlantBatchPlantingsRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : PlantBatchClient.PostPlantBatchPlantingsAsync(licenseNumber, body);
    ...
    Task IPlantBatchClient.PostPlantBatchPackagesAsync(string licenseNumber, bool? isFromMotherPlant,
        IEnumerable<PostPlantBatchPackagesRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : PlantBatchClient.PostPlantBatchPackagesAsync(licenseNumber, isFromMotherPlant, body);

    [MapsToApi(MetrcEndpoint.post_plantbatches_v2_packages)]
    Task IPlantBatchClient.PostPlantBatchPackagesAsync(string licenseNumber, bool? isFromMotherPlant,
        IEnumerable<PostPlantBatchPackagesRequest> body, CancellationToken cancellationToken) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : PlantBatchClient.PostPlantBatchPackagesAsync(licenseNumber, isFromMotherPlant, body, cancellationToken);
    ...
    Task IPlantBatchClient.PostPlantBatchPackageFromMotherPlantAsync(string licenseNumber,
        IEnumerable<PostPlantBatchPackageFromMotherPlantRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : PlantBatchClient.PostPlantBatchPackageFromMotherPlantAsync(licenseNumber, body);
    ...
    Task IPlantBatchClient.PostPlantBatchGrowthPhaseAsync(string licenseNumber,
        IEnumerable<PostPlantBatchGrowthPhaseRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : PlantBatchClient.PostPlantBatchGrowthPhaseAsync(licenseNumber, body);
    ...
    Task IPlantBatchClient.PutPlantBatchTagAsync(string licenseNumber, IEnumerable<PutPlantBatchTagRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : PlantBatchClient.PutPlantBatchTagAsync(licenseNumber, body);
    ...
    Task IPlantBatchClient.PutPlantBatchStrainAsync(string licenseNumber, IEnumerable<PutPlantBatchStrainRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : PlantBatchClient.PutPlantBatchStrainAsync(licenseNumber, body);
    ...
    Task IPlantBatchClient.PutPlantBatchLocationAsync(string licenseNumber, IEnumerable<PutPlantBatchLocationRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : PlantBatchClient.PutPlantBatchLocationAsync(licenseNumber, body);
    ...
    Task IPlantBatchClient.PostPlantBatchWasteAsync(string licenseNumber,
        IEnumerable<PostPlantBatchWasteRequest> body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
