...
public partial class MetrcService : IPlantBatchClient
{
    ...
    Task IPlantBatchClient.DestroyPlantBatchAsync(string licenseNumber, IEnumerable<DestroyPlantBatchRequest>? body) =>
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : PlantBatchClient.DestroyPlantBatchAsync(licenseNumber, body);
    ...
    Task IPlantBatchClient.DestroyPlantBatchAsync(string licenseNumber, IEnumerable<DestroyPlantBatchRequest>? body,
        ...
        !CheckEndpointAvailability(MethodBase.GetCurrentMethod())
            ? Task.CompletedTask
            : PlantBatchClient.DestroyPlantBatchAsync(licenseNumber, body, cancellationToken);
}