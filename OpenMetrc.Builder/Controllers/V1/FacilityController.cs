...
{
    [HttpGet, MapsToApi(MetrcEndpoint.get_facilities_v1_)]
    [Authorize, ApiAuthorizationFilter]
    [ProducesResponseType(typeof(IEnumerable<Facility>), StatusCodes.Status200OK)]
    [SwaggerOperation(Summary = "A Facility represents a building licensed for the growing, processing, and/or selling of product",
